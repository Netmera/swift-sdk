...
#ifndef NETMERACORE_SWIFT_H
#define NETMERACORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NetmeraCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// URLSessionDelegate implementation that performs SSL pinning using an injected CertificateValidating instance.
SWIFT_CLASS("_TtC11NetmeraCore18SSLPinningDelegate")
@interface SSLPinningDelegate : NSObject <NSURLSessionDelegate>
/// URLSession delegate method that handles server trust authentication challenges.
